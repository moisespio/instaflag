...
app.factory('pollingService', function ($http, $timeout, $q) {
	...
	(function poll() {
		$http.jsonp('https://api.instagram.com/v1/tags/agenciaescala/media/recent?callback=?&client_id=4161e7120cfb45979576eba99b85119f&callback=JSON_CALLBACK').success(function(response) {
